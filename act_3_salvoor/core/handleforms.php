...
if (isset($_POST['editbutton'])) {
	...
	if (!empty($username) && !empty($First_name) && !empty($Last_name) && !empty($profession) && !empty($statusinLife)  && !empty($experience)  && !empty($Age)) {
			$query = insertIntoform($pdo, $username, $First_name, $Last_name, $profession, $statusinLife, $experience, $Age);
